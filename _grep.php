...
$startPathes = <<<PATH
/wa-apps/shop/plugins,
/wa-data/public/shop/themes/incart,
/wa-data/public/site/themes/incart
PATH;

$PHP_Grep_version = "1.0.5"; // есть изменения на 1.0.6
			...
			<div class="l-row">
				<label class="form-item-label">
					...
					<div class="w-input --row">
						...
						<?php 
						$thisContent = $startPathes;
						if( !empty( $_GET['search-path'] ) ){
							$thisContent = @urldecode( $_GET['search-path'] );
						}
						elseif ( isset( $_GET['search-path']) ) {
							$thisContent = '/';
						}
						?>
						<textarea
